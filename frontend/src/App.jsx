...
export default function CareerAssistantApp() {
  ...
  return (
    <div data-accent={accent} className={cx("flex flex-col md:block w-full pb-40 md:pb-0 overscroll-y-none transition-colors duration-300", !isFullScreenPage ? "pt-16 min-h-[calc(100dvh-4rem)]" : "min-h-[100dvh]", tokens.bg, tokens.text)}>
