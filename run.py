...
# Setup testing data
user_credentials = {"email": "billu_test@gmail.com", "password": "StrongPassword123!"}
...
profile_res = requests.post(
    f"{BASE_URL}/auth/profile", json=personal_survey, headers=HEADERS
)
...
personalized_res = requests.post(
    f"{BASE_URL}/recommendations/personalized", json=anonymous_payload, headers=HEADERS
)
